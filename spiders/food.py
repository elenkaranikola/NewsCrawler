...
class DogSpider(CrawlSpider):
    ...
    urls = ['http://newpost.gr/gefsi?page={}'.format(x) for x in range(1,1227)]+['https://www.tanea.gr/category/recipes/page/{}'.format(x) for x in range(1,TANEA_VARS['FOOD_PAGES'])]
    start_urls = urls[:]  
    rules = ( 

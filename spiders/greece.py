...
from news2.settings import LIFO_VARS,EFSYN_VARS,POPAGANDA_VARS,PROTAGON_VARS
from news2.settings import TOPONTIKI_VARS,GENERAL_CATEGORIES,READER_VARS
from news2.settings import PERIODISTA_VARS,NEWPOST_VARS
...
class DogSpider(CrawlSpider):
    ...
    rules = (
        ...
        Rule(LinkExtractor(allow=('newpost.gr/ellada'), deny=()), callback='parse_newpost', follow=True), 
    )
